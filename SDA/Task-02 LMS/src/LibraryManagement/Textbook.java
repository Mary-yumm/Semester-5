...
public class Textbook extends Book implements Loanable{
    ...
    Textbook(int id, String title, String author, String ISBN, int year, String genre, boolean loan_status,double base_loan_fee,String book_type) {
        super(id, title, author, ISBN, year, genre, loan_status,base_loan_fee,true,true,book_type);
